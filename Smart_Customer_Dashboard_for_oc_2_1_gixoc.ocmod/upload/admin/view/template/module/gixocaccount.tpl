      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-gixocaccount" class="form-horizontal">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab-design" data-toggle="tab"><i class="fa fa-cog"></i> <?php echo $entry_main;?></a></li>
            <li><a href="#tab-customer" data-toggle="tab"><i class="fa fa-user"></i> <?php echo $entry_customer;?></a></li>
            <li><a href="#tab-affiliate" data-toggle="tab"><i class="fa fa-share-alt"></i> <?php echo $entry_affiliate;?></a></li>
          </ul>
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-9">
                                ...
                                <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></span>
...
html += '                                <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></span>';
